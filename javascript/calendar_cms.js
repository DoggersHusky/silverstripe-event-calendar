    ...
    $(function() {
        ...
        $(".field.checkbox.recursion").entwine({
            onmatch: function() {
                ...
                var $recursion = this;
                var $customRecursionType = $tab
                    .find("#Form_EditForm_CustomRecursionType_Holder")
                    .hide();
                ...
                var $recurringDaysOfWeek = $tab
                    .find("#Form_EditForm_RecurringDaysOfWeek_Holder")
                    .hide();
                var $recurringDaysOfMonth = $tab
                    .find("#Form_EditForm_RecurringDaysOfMonth_Holder")
                    .hide();
                var $monthlyRecursionType1 = $tab
                    .find("#Form_EditForm_MonthlyRecursionType1_Holder")
                    .hide();
                var $monthlyRecursionType2 = $tab
                    .find("#Form_EditForm_MonthlyRecursionType2_Holder")
                    .hide();
